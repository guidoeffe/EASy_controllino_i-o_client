...
// costruzione url
String easyTerminalID = "1122334455667788"; // ID del terminale I/O (deve essere inserito anche sul server EASy)
...
void loop() {
  ...
  Serial.println(easyUrlPzScarti); 
  }
  }
  ...
  if (cl_status == digitalRead(CONTROLLINO_A2)) {
    ...
    easyUrlParameters = String(easyUrlPage + easyTerminalID + "/" + busStartStop + "/" + cl_status + "/" + easyTimestamp);
    Serial.println(easyUrlParameters);   
    } 
