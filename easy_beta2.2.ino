...
unsigned long intervalSendUrlPzBuoni = 7000; // Setta l'intervallo di tempo (millisecondi) per l'invio dei Pezzi buoni
unsigned long timeStartPzBuoni = 0;
unsigned long latentPzBuoni = 20; // Setta l'intervallo di tempo (millisecondi) per la lettura dei pezzi buoni [evita false letture]
unsigned long timerSendUrlPzScarti = 0;
unsigned long intervalSendUrlPzScarti = 10000; // Setta l'intervallo di tempo (millisecondi) per l'invio dei Pezzi scarti 
unsigned long timeStartPzScarti = 0; 
unsigned long latentPzScarti = 20; // Setta l'intervallo di tempo (millisecondi) per la lettura dei pezzi scarti [evita false letture]
unsigned long timeStartRunStop = 0;
unsigned long latentRunStop = 20; // Setta l'intervallo di tempo (millisecondi) per la lettura Run/Stop [evita false letture]
