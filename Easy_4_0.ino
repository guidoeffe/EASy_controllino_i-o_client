...
String txtSwVersion = "4.0";

/*EASy Controllino Ver. 4.0
...
String easyServer = "servereasymes.net"; //inserire lo stesso dominio in tutt'e due le variabili
RestClient client = RestClient("servereasymes.net");
String response;
